...
class VA_Home_Archive extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'va-home.php', __( 'Home', APP_TD ), array( 'internal_use_only' => true ) );
	}
...
class VA_Blog_Archive extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'index.php', __( 'Blog', APP_TD ), array( 'internal_use_only' => true ) );
...
class VA_Listing_Categories extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'categories-list-listing.php', __( 'Categories', APP_TD ), array( 'internal_use_only' => true ) );
...
class VA_Listing_Create extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'create-listing.php', __( 'Create Listing', APP_TD ), array( 'internal_use_only' => true ) );
