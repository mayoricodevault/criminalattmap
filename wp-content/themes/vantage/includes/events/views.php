...
class VA_Event_Create extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'create-event.php', __( 'Create Event', APP_TD ), array( 'internal_use_only' => true ) );
...
class VA_Event_Categories extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'categories-list-event.php', __( 'Event Categories', APP_TD ), array( 'internal_use_only' => true ) );
