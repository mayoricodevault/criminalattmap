...
function _va_register_event_post_types() {
	...
	$args = array(
		...
		'query_var' => true,
		'can_export' => true,
		'rewrite' => array( 'slug' => $options->event_permalink, 'with_front' => false ),
...
function _va_register_event_taxonomies() {
	...
	$labels = array(
		...
		'menu_name' => __( 'Event Categories', APP_TD ),
	);
	...
	$args = array(
		...
		'query_var' => true,
		'rewrite' => array( 'slug' => $options->event_permalink . '/' . $options->event_cat_permalink, 'with_front' => false ),
	);
	...
	$args = array(
		...
		'query_var' => true,
		'rewrite' => array( 'slug' => $options->event_permalink . '/' . $options->event_tag_permalink, 'with_front' => false ),
	);
	...
	$args = array(
		...
		// Hide Standard Admin Taxonomy UI
		'public' => false,
		'show_in_nav_menus' => false,
		'show_ui' => false,
		'show_tagcloud' => false,
		...
		'hierarchical' => true,
		'query_var' => true,
		'rewrite' => array( 'slug' => $options->event_permalink . '/' . $options->event_day_permalink, 'with_front' => false ),
	);
